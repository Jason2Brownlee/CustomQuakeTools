# list all files in "wishlist url" that are not in "wishlist"
...
def main():
    ...
    print()
    for name in sorted(list(wishlist_urls_files)):
        # check if it exists in the wishlist
        if name not in wishlist_files:
            # print(f'{name} in wishlist urls, not in wishlist')
            print(name)
